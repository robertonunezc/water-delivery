...
def _balance_history_item(balance_tx: Any) -> dict[str, Any]:
    ...
    return {
        ...
        'notes': balance_tx.notes,
        'note_modal_id': f'payment-note-modal-balance-transaction-{balance_tx.id}',
        'note_aria_label': f'Ver nota de saldo #{balance_tx.id}',
        'note_title': f'Nota de saldo #{balance_tx.id}',
...
def _credit_history_item(credit_tx: Any) -> dict[str, Any]:
    ...
    return {
        ...
        'notes': credit_tx.notes,
        'note_modal_id': f'payment-note-modal-credit-transaction-{credit_tx.id}',
        'note_aria_label': f'Ver nota de credito #{credit_tx.id}',
        'note_title': f'Nota de credito #{credit_tx.id}',
