...
5. **PR Strategy**: Split the implementation into logical commits or PRs for easier review and integration. No PR can be too small if it represents a meaningful step in the implementation process. No PR can be too large allways try to create PR with no more than 300 lines of code changes if possible. If not go to 500 lines of code. If yo need to go beyond 500 let me know and propose a strategy to split the implementation into multiple PRs. 
